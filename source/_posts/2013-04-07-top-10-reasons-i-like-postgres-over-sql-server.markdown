...
4. Partitioning out of the box. Our data is growing and we need to do something about it but perhaps don't want to take on the drama of sharding yet. Partitioning can be a pretty good fix for this and you get it out of the box. As for SQL Server, basic table partitioning is only available in Enterprise Elite edition. Yep, you're writing huge checks to pull this off.
